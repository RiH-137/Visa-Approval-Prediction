## data transformation is a process of converting raw data into a format that is more appropriate for analysis
...
## using static method to read the data without creating an object of the class(self)
    @staticmethod
